...
public class CodeGenerator {
    ...
    private String emitExpr(Ast.Expr expr) {
        ...
        // Binary already wraps its own output in parentheses, so Grouping just
        // passes the inner expression through instead of adding a second pair
        // (this previously produced output like "((2 + 3))" for "(2 + 3)").
